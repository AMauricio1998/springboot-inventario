...
import com.idgs101.inventario.dao.ICategoryDao;
import com.idgs101.inventario.dao.IProductDao;
...
public class ProductService implements IProductService {
	...
	public ProductService(ICategoryDao categoryDao, IProductDao productDao) {
		super();
	...
	public ResponseEntity<ProductResponseRest> save(Product product, Long categoryId) {
		...
		try {
			...
			if( category.isPresent()) {
				...
				response.setMetadata("respuesta erronea", "-1", "Categoria del producto no encontrada");
